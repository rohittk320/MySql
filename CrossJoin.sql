...
select city from customers union select city from suppliers;   -- only common record show ,Every SELECT statement within UNION must have the same number of columns
select city from customers union select city from suppliers;
select city from customers union all select city from suppliers;   -- all records show
